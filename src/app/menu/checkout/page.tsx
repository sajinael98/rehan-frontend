...
import { ActionIcon, Box, Button, Flex, Group, ScrollArea, Stack, Text } from '@mantine/core'
...
const CheckoutPage = () => {
  ...
  return (
    <Stack h={"100%"} >
      <Button onClick={router.back} leftIcon={<IconArrowLeft />} variant='subtle' size='sm' sx={{alignSelf: "flex-start"}}>
        الرجوع الى القائمة
      </Button>

      <Group position='center' bg="#F1EECC" py="sm" sx={{ borderRadius: "var(--mantine-spacing-xl)" }}>
      ...
      <div style={{ position: "relative", flex: 1 }}>
        <ScrollArea style={{ position: "absolute", top: 0, bottom: 0, left: 0, right: 0, width: "100%", zIndex: 1222 }} type='never'>
